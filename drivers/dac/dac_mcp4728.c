...
#define MCP4728_MAX_CHANNEL			4
#define MCP4728_RESOLUTION			0xC
#define MCP4728_DAC_MAX_VAL			((2 << (MCP4728_RESOLUTION - 1)) - 1)
#define MCP4728_MULTI_WRITE_CMD_VAL		8
#define MCP4728_MULTI_WRITE_CMD_POS		3
#define MCP4728_MULTI_WRITE_CHANNEL_POS		1
#define MCP4728_MULTI_WRITE_REFERENCE_POS	7
#define MCP4728_MULTI_WRITE_POWER_DOWN_POS	5
#define MCP4728_MULTI_WRITE_POWER_DOWN_MASK	0X3
#define MCP4728_MULTI_WRITE_GAIN_POS		4
#define MCP4728_MULTI_WRITE_DAC_UPPER_VAL_POS	8
...
#define INST_DT_MCP4728(index)							\
	static const struct mcp4728_config mcp4728_config_##index = {		\
		...
		COND_CODE_1(DT_NODE_HAS_PROP(index, gain),			\
