...
ICM_20948_Status_e ICM_20948::setSampleMode(uint8_t sensor_id_bm, uint8_t lp_config_cycle_mode)
{
  ...
  k_sleep(K_MSEC(1000)); // Give the ICM20948 time to change the sample mode (see issue #8)
  return status;
}
...
ICM_20948_Status_e ICM_20948_I2C::begin(const struct device *wirePort, bool ad0val, uint8_t ad0pin)
{
  // Associate
  _ad0 = ad0pin;
  _i2c = wirePort;
